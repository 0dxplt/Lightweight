...
-- VARIANTI SQUAT & GAMBE
(79, 'Squat a Corpo Libero (Air Squat)', 'Versione base dello squat senza sovraccarico. Ottimo per riscaldamento o circuiti.', NULL, 1),
(80, 'Goblet Squat', 'Squat tenendo un manubrio o kettlebell al petto. Insegna a mantenere il busto dritto.', NULL, 1),
(81, 'Squat al Multipower (Smith Machine)', 'Squat con traiettoria guidata. Permette di spostare i piedi più avanti per focus sui quadricipiti.', NULL, 2),
(82, 'Hack Squat (Macchinario)', 'Squat guidato con schienale in appoggio. Elimina il carico sulla bassa schiena, isolando i quadricipiti.', NULL, 2),
(83, 'Pendulum Squat', 'Macchinario avanzato che segue un arco di movimento naturale. Devastante per i quadricipiti.', NULL, 3),
(84, 'Belt Squat', 'Squat eseguito con una cintura sovraccaricata legata in vita (alla macchina o ai cavi). Zero carico spinale.', NULL, 2),

-- VARIANTI SPINTE PETTO (Chest Press / Panca)
(85, 'Panca Piana al Multipower', 'Spinta orizzontale guidata. Permette di spingere al cedimento in totale sicurezza.', NULL, 1),
(86, 'Panca Inclinata al Multipower', 'Spinta inclinata guidata per isolare perfettamente i fasci alti del petto.', NULL, 1),
(87, 'Chest Press Convergente (Macchina a Leve)', 'Macchinario (es. Hammer Strength) dove le braccia convergono al centro durante la spinta.', NULL, 2),
(88, 'Incline Chest Press Convergente', 'Variante della macchina a leve inclinata per il petto alto.', NULL, 2),
(89, 'Floor Press con Bilanciere', 'Spinta eseguita sdraiati a terra. Il pavimento ferma i gomiti, azzerando lo slancio e isolando i tricipiti.', NULL, 2),
(90, 'Spinte ai Cavi da Sdraiato', 'Spinte orizzontali eseguite su panca posizionata in mezzo ai cavi. Tensione estrema continua.', NULL, 2),

-- VARIANTI TIRATA DORSO (Rematori / Lat)
(91, 'Rematore Pendlay (Pendlay Row)', 'Rematore esplosivo in cui il bilanciere torna a terra a ogni ripetizione. Zero inerzia.', NULL, 3),
(92, 'Seal Row', 'Rematore con bilanciere o manubri eseguito sdraiati a pancia in giù su una panca alta. Impossibile "cheattare".', NULL, 2),
(93, 'Rematore al Macchinario (Chest Supported Row)', 'Rematore su macchina con appoggio per il petto. Salva la bassa schiena.', NULL, 1),
(94, 'High Row Convergente', 'Macchina a leve con tirata dall''alto verso il basso (ibrido tra lat machine e rematore).', NULL, 2),
(95, 'Meadows Row (Rematore alla Mina)', 'Rematore a un braccio eseguito tenendo l''estremità di un bilanciere incastrato a terra (landmine).', NULL, 3),

-- VARIANTI STACCO (Deadlift)
(96, 'Stacco con Trap Bar (Hex Bar)', 'Stacco eseguito all''interno di una barra esagonale. Più sicuro per la schiena, maggiore focus sui quadricipiti.', NULL, 2),
(97, 'Stacco dai Blocchi (Block Pull)', 'Stacco in cui il bilanciere parte da rialzi. Focus sulla parte finale dell''alzata e sui trapezi.', NULL, 3),
(98, 'Stacco alla Rumena con Manubri', 'Variante del RDL usando i manubri per un maggiore range di movimento e asimmetria.', NULL, 2),

-- VARIANTI SPALLE
(99, 'Shoulder Press Convergente', 'Spinta verso l''alto su macchina a leve. Traiettoria ottimale per i deltoidi.', NULL, 1),
(100, 'Lento Avanti al Multipower', 'Spinta verticale guidata da seduti. Isolamento puro senza pensiero all''equilibrio.', NULL, 1),
(101, 'Landmine Press (Spinta alla Mina)', 'Spinta unilaterale verso l''alto/avanti con bilanciere incastrato a terra. Ottimo per spalle sensibili.', NULL, 2),

-- VARIANTI BRACCIA
(102, 'Curl al Cavo Basso', 'Flessione dei bicipiti al cavo per mantenere una resistenza costante durante tutto l''arco.', NULL, 1),
(103, 'Tricep Press (Macchina Dip)', 'Macchinario guidato da seduti per simulare le dip alle parallele premendo verso il basso.', NULL, 1),
...
-- Air Squat (60% Quad, 30% Glutei, 10% Femorali)
(79, 10, 60.0), (79, 12, 30.0), (79, 11, 10.0),
-- Goblet Squat
(80, 10, 65.0), (80, 12, 20.0), (80, 9, 15.0),
-- Smith Machine Squat
(81, 10, 70.0), (81, 12, 20.0), (81, 11, 10.0),
-- Hack Squat
(82, 10, 85.0), (82, 12, 15.0),
-- Pendulum Squat
(83, 10, 90.0), (83, 12, 10.0),
-- Belt Squat
(84, 10, 75.0), (84, 12, 25.0),

-- Panca Piana Multipower
(85, 1, 75.0), (85, 7, 15.0), (85, 3, 10.0),
-- Panca Inclinata Multipower
(86, 1, 65.0), (86, 3, 25.0), (86, 7, 10.0),
-- Chest Press Convergente
(87, 1, 80.0), (87, 3, 10.0), (87, 7, 10.0),
-- Incline Chest Press Convergente
(88, 1, 70.0), (88, 3, 20.0), (88, 7, 10.0),
-- Floor Press
(89, 7, 50.0), (89, 1, 40.0), (89, 3, 10.0),
-- Spinte Cavi Sdraiato
(90, 1, 90.0), (90, 3, 10.0),

-- Pendlay Row
(91, 2, 70.0), (91, 14, 20.0), (91, 6, 10.0),
-- Seal Row
(92, 2, 75.0), (92, 14, 15.0), (92, 6, 10.0),
-- Chest Supported Row
(93, 2, 80.0), (93, 6, 15.0), (93, 5, 5.0),
-- High Row Convergente
(94, 2, 70.0), (94, 5, 15.0), (94, 6, 15.0),
-- Meadows Row
(95, 2, 65.0), (95, 14, 20.0), (95, 6, 15.0),

-- Trap Bar Deadlift
(96, 10, 40.0), (96, 12, 30.0), (96, 11, 20.0), (96, 14, 10.0),
-- Block Pull
(97, 14, 40.0), (97, 12, 30.0), (97, 11, 30.0),
-- RDL Manubri
(98, 11, 60.0), (98, 12, 30.0), (98, 14, 10.0),

-- Shoulder Press Convergente
(99, 3, 70.0), (99, 4, 15.0), (99, 7, 15.0),
-- Lento Multipower
(100, 3, 65.0), (100, 4, 20.0), (100, 7, 15.0),
-- Landmine Press
(101, 3, 60.0), (101, 1, 20.0), (101, 7, 10.0), (101, 9, 10.0),

-- Curl Cavo Basso
(102, 6, 95.0), (102, 8, 5.0),
-- Tricep Press (Macchina)
(103, 7, 85.0), (103, 1, 10.0), (103, 3, 5.0),
-- Adductor Machine
...
(2, 'Stati Uniti', 'US', 'https://flagcdn.com/us.svg'),
(3, 'Spagna', 'ES', 'https://flagcdn.com/es.svg'),
(4, 'Francia', 'FR', 'https://flagcdn.com/fr.svg'),
(5, 'Germania', 'DE', 'https://flagcdn.com/de.svg'),
(6, 'Regno Unito', 'GB', 'https://flagcdn.com/gb.svg'),
(7, 'Giappone', 'JP', 'https://flagcdn.com/jp.svg'),
(8, 'Brasile', 'BR', 'https://flagcdn.com/br.svg'),
(9, 'Canada', 'CA', 'https://flagcdn.com/ca.svg'),
(10, 'Australia', 'AU', 'https://flagcdn.com/au.svg'),
(11, 'Portogallo', 'PT', 'https://flagcdn.com/pt.svg'),
(12, 'Paesi Bassi', 'NL', 'https://flagcdn.com/nl.svg'),
(13, 'Belgio', 'BE', 'https://flagcdn.com/be.svg'),
(14, 'Svizzera', 'CH', 'https://flagcdn.com/ch.svg'),
(15, 'Austria', 'AT', 'https://flagcdn.com/at.svg'),
(16, 'Svezia', 'SE', 'https://flagcdn.com/se.svg'),
(17, 'Norvegia', 'NO', 'https://flagcdn.com/no.svg'),
(18, 'Danimarca', 'DK', 'https://flagcdn.com/dk.svg'),
(19, 'Finlandia', 'FI', 'https://flagcdn.com/fi.svg'),
(20, 'Grecia', 'GR', 'https://flagcdn.com/gr.svg'),
(21, 'Irlanda', 'IE', 'https://flagcdn.com/ie.svg'),
(22, 'Polonia', 'PL', 'https://flagcdn.com/pl.svg'),
(23, 'Repubblica Ceca', 'CZ', 'https://flagcdn.com/cz.svg'),
(24, 'Ungheria', 'HU', 'https://flagcdn.com/hu.svg'),
(25, 'Romania', 'RO', 'https://flagcdn.com/ro.svg'),
(26, 'Turchia', 'TR', 'https://flagcdn.com/tr.svg'),
(27, 'Cina', 'CN', 'https://flagcdn.com/cn.svg'),
(28, 'India', 'IN', 'https://flagcdn.com/in.svg'),
(29, 'Corea del Sud', 'KR', 'https://flagcdn.com/kr.svg'),
(30, 'Messico', 'MX', 'https://flagcdn.com/mx.svg'),
(31, 'Argentina', 'AR', 'https://flagcdn.com/ar.svg'),
(32, 'Cile', 'CL', 'https://flagcdn.com/cl.svg'),
(33, 'Colombia', 'CO', 'https://flagcdn.com/co.svg'),
(34, 'Perù', 'PE', 'https://flagcdn.com/pe.svg'),
(35, 'Sudafrica', 'ZA', 'https://flagcdn.com/za.svg'),
(36, 'Egitto', 'EG', 'https://flagcdn.com/eg.svg'),
(37, 'Marocco', 'MA', 'https://flagcdn.com/ma.svg'),
(38, 'Nigeria', 'NG', 'https://flagcdn.com/ng.svg'),
(39, 'Arabia Saudita', 'SA', 'https://flagcdn.com/sa.svg'),
(40, 'Emirati Arabi Uniti', 'AE', 'https://flagcdn.com/ae.svg'),
(41, 'Israele', 'IL', 'https://flagcdn.com/il.svg'),
(42, 'Thailandia', 'TH', 'https://flagcdn.com/th.svg'),
(43, 'Vietnam', 'VN', 'https://flagcdn.com/vn.svg'),
(44, 'Indonesia', 'ID', 'https://flagcdn.com/id.svg'),
(45, 'Singapore', 'SG', 'https://flagcdn.com/sg.svg'),
(46, 'Nuova Zelanda', 'NZ', 'https://flagcdn.com/nz.svg'),
(47, 'Croazia', 'HR', 'https://flagcdn.com/hr.svg'),
(48, 'Serbia', 'RS', 'https://flagcdn.com/rs.svg'),
(49, 'Bulgaria', 'BG', 'https://flagcdn.com/bg.svg'),
(50, 'Ucraina', 'UA', 'https://flagcdn.com/ua.svg');
...
(1, 'Gold Gym Roma', 'Via del Corso 12, Roma', 41.9028, 12.4964),
(2, 'Technogym Milano', 'Via Dante 5, Milano', 45.4642, 9.1900),
(3, 'Brooklyn Iron', '5th Ave, New York', 40.7128, -74.0060),
(4, 'Muscle Beach Gym', 'Venice Beach, Los Angeles', 33.9850, -118.4695),
(5, 'McFit Berlino', 'Alexanderplatz 3, Berlino', 52.5200, 13.4050),
(6, 'Pure Gym London', 'Oxford Street 100, Londra', 51.5165, -0.1424),
(7, 'Basic-Fit Paris', 'Rue de Rivoli 45, Parigi', 48.8566, 2.3522),
(8, 'Spartan Training Madrid', 'Calle Mayor 10, Madrid', 40.4168, -3.7038),
(9, 'FitX Munich', 'Marienplatz 1, Monaco', 48.1351, 11.5820),
(10, 'CrossFit Tokyo', 'Shibuya 2-10, Tokyo', 35.6895, 139.6917),
(11, 'Elite Fitness Lisbon', 'Av. Liberdade 20, Lisbona', 38.7167, -9.1333),
(12, 'Power House Sydney', 'George St 500, Sydney', -33.8688, 151.2093),
(13, 'Iron Temple Rio', 'Copacabana, Rio de Janeiro', -22.9068, -43.1729),
(14, 'Health City Amsterdam', 'Damrak 1, Amsterdam', 52.3702, 4.8952),
(15, 'Olympic Gym Athens', 'Syntagma Square, Atene', 37.9838, 23.7275),
(16, 'Viking Strength Oslo', 'Karl Johans gate, Oslo', 59.9139, 10.7522),
(17, 'Celtic Crossfit Dublin', 'Grafton St, Dublino', 53.3498, -6.2603),
(18, 'Zalgiris Gym Kaunas', 'Laisves al. 1, Kaunas', 54.8985, 23.9036),
(19, 'Red Star Fitness Belgrade', 'Knez Mihailova, Belgrado', 44.7866, 20.4489),
(20, 'Hellenic Force Thessaloniki', 'Egnatia St, Salonicco', 40.6401, 22.9444),
(21, 'Alps Strength Zurich', 'Bahnhofstrasse 10, Zurigo', 47.3769, 8.5417),
(22, 'Danube Fitness Vienna', 'Stephansplatz 1, Vienna', 48.2082, 16.3738),
(23, 'Royal Gym Brussels', 'Grand Place, Bruxelles', 50.8503, 4.3517),
(24, 'Catalan Power Barcelona', 'La Rambla 50, Barcellona', 41.3851, 2.1734),
(25, 'Milan Fitness Club', 'Corso Buenos Aires, Milano', 45.4791, 9.2111),
(26, 'Neapolitan Muscle', 'Via Toledo, Napoli', 40.8401, 14.2496),
(27, 'Turin Weightlifting', 'Via Roma 100, Torino', 45.0703, 7.6869),
(28, 'Empire State Gym', 'Empire State Bldg, NY', 40.7484, -73.9857),
(29, 'Windy City CrossFit', 'Michigan Ave, Chicago', 41.8781, -87.6298),
(30, 'Lyon Athletic', 'Place Bellecour, Lione', 45.7578, 4.8320),
(31, 'Marseille Boxe & Gym', 'Vieux Port, Marsiglia', 43.2965, 5.3698),
(32, 'Hamburgh Kraft', 'Reeperbahn, Amburgo', 53.5488, 9.9600),
(33, 'Manchester United Fitness', 'Deansgate, Manchester', 53.4808, -2.2426),
(34, 'Anfield Strength', 'Anfield Rd, Liverpool', 53.4084, -2.9916),
(35, 'Shunsuke Dojo Osaka', 'Dotonbori, Osaka', 34.6937, 135.5023),
(36, 'Kyoto Zen Fitness', 'Gion District, Kyoto', 35.0116, 135.7681),
(37, 'Paulista Gym', 'Avenida Paulista, San Paolo', -23.5505, -46.6333),
(38, 'CN Tower Climb Gym', 'Front St W, Toronto', 43.6426, -79.3871),
(39, 'Rainy City Gym', 'Granville St, Vancouver', 49.2827, -123.1207),
(40, 'Outback Strength', 'Collins St, Melbourne', -37.8136, 144.9631),
(41, 'Dragon Gate Gym', 'Wangfujing, Pechino', 39.9042, 116.4074),
(42, 'Bollywood Body', 'Colaba Causeway, Mumbai', 19.0760, 72.8777),
(43, 'Bosphorus Fitness', 'Istiklal Avenue, Istanbul', 41.0082, 28.9784),
(44, 'Magyar Strength', 'Andrassy Ut, Budapest', 47.4979, 19.0402),
(45, 'Vltava Gym Prague', 'Charles Bridge, Praga', 50.0755, 14.4378),
(46, 'Warsaw Iron', 'Nowy Swiat, Varsavia', 52.2297, 21.0122),
